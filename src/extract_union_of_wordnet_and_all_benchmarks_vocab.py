...
def main(_):
  vocab_file = '/usr/local/google/home/agoldie/data/wordnet-28086.pkl'
  ...
  #print(len(union_vocab))
  full_union_file = '/usr/local/google/home/agoldie/data/wordnet_and_all_benchmarks_vocab.pkl'
