...
# Lint as: python3
"""Explore isotropy of word2vec embeddings.
"""
...
#  before = '/usr/local/google/home/agoldie/data/word2vec/original-full.sstable'
#  after_ours = '/usr/local/google/home/agoldie/data/word2vec/sorted_by_freq_varying_size_start0/removed-3-subtracted-start0-vocab100000.sstable'
  #after_abtt = '/usr/local/google/home/agoldie/data/word2vec/removed-subtracted-full-v2.sstable'
  after_ours_dir = '/usr/local/google/home/agoldie/data/word2vec/sorted_by_freq_varying_size_start0/'


  # before = '/usr/local/google/home/agoldie/data/glove/glove.sstable'
  # #after_ours = '/usr/local/google/home/agoldie/data/glove/sorted_by_freq_varying_size_start0/removed-2-subtracted-start0-vocab50000.sstable'
  # after_abtt = '/usr/local/google/home/agoldie/data/glove/removed-subtracted-full.sstable'
  # after_ours_dir = '/usr/local/google/home/agoldie/data/glove/sorted_by_freq_varying_size_start0/'

  tables = os.listdir(after_ours_dir)
  tables = [t for t in tables if t.endswith('sstable') and 'removed' in t]
  tables = [t for t in tables if '1087156' not in t and and '750000' not in t and '500000' not in t]
  print(tables)

  #tables = [after_ours] #, before, after_abtt]
  table_map = {}
  for table in tables:
    print(table)
    keys, embeddings = get_embeddings(os.path.join(after_ours_dir, table))
    ...
    table_map[base] = (principal_components, singular_values)

    #import pdb; pdb.set_trace()
    pcs_and_svs_file = os.path.join(after_ours_dir, 'after_ours.pkl')
