...
flags.DEFINE_string(
    'vocab_files', '',
    'Comma-separated list of Pkl files containing different subsets of vocabulary to consider when calculating the mean.'
)
...
def main(_):
  vocab_files = [FLAGS.vocab_files]
  if ',' in FLAGS.vocab_files:
    vocab_files = FLAGS.vocab_files.split(',')
  input_file = FLAGS.input_embedding_table
