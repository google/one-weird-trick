...
# Lint as: python3
"""Explore isotropy of GLOVE embeddings before transformations.
"""
...
def main(argv):
  ...
  before_dir = '/usr/local/google/home/agoldie/data/glove/sorted_by_freq_varying_size_start0/'
  ...
  for table in tables:
    ...
    pcs_and_svs_file = os.path.join(before_dir, 'before.pkl')
