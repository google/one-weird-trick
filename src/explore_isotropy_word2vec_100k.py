...
# Lint as: python3
"""Explore isotropy of word2vec 100k vocab embeddings.
"""
...
def main(argv):
  ...
  tables = [os.path.join(abtt_dir, 'removed-3-subtracted-start0-vocab100000.sstable')]
  for table in tables:
    print(table)
    ...
    pcs_and_svs_file = os.path.join(abtt_dir, 'removed-3-subtracted-start0-vocab100000.pkl')
